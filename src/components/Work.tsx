...
const Work = () => {
    return (
        <div className=" w-full ">
            <div className="mx-20 w-1/2 md:text-xl">
                <div className="text-3xl text-gray-600 tracking-tight font-bold mt-[50px] ">
                    • Our Work
                </div>
                <div className="text-white text-5xl mt-10">
                    Global teams trust us to take on complex challenges, push
                    creative boundaries, and move fast when it matters most. We
                    bring clarity, momentum, and a little heat to every project.
                </div>
            </div>
